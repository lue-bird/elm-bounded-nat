module NNats exposing
    ...
    , nat162, nat163, nat164, nat165, nat166, nat167, nat168, nat17, nat18, nat19, nat2
    , nat20, nat21, nat22, nat23, nat24, nat25, nat26, nat27, nat28, nat29, nat3, nat30, nat31
    , nat32, nat33, nat34, nat35, nat36, nat37, nat38, nat39, nat4, nat40, nat41, nat42, nat43
    , nat44, nat45, nat46, nat47, nat48, nat49, nat5, nat50, nat51, nat52, nat53, nat54, nat55
    , nat56, nat57, nat58, nat59, nat6, nat60, nat61, nat62, nat63, nat64, nat65, nat66, nat67
    , nat68, nat69, nat7, nat70, nat71, nat72, nat73, nat74, nat75, nat76, nat77, nat78, nat79
    , nat8, nat80, nat81, nat82, nat83, nat84, nat85, nat86, nat87, nat88, nat89, nat9, nat90
    , nat91, nat92, nat93, nat94, nat95, nat96, nat97, nat98, nat99
    )
...
{-| The `Nat` 161.
-}
nat161 : Nat (ValueN Nat161 (Nat161Plus more) (Is a To (Nat161Plus a)) (Is b To (Nat161Plus b)))
nat161 =
    Nat 161
...
{-| The `Nat` 162.
-}
nat162 : Nat (ValueN Nat162 (Nat162Plus more) (Is a To (Nat162Plus a)) (Is b To (Nat162Plus b)))
nat162 =
    Nat 162
...
{-| The `Nat` 163.
-}
nat163 : Nat (ValueN Nat163 (Nat163Plus more) (Is a To (Nat163Plus a)) (Is b To (Nat163Plus b)))
nat163 =
    Nat 163
...
{-| The `Nat` 164.
-}
nat164 : Nat (ValueN Nat164 (Nat164Plus more) (Is a To (Nat164Plus a)) (Is b To (Nat164Plus b)))
nat164 =
    Nat 164
...
{-| The `Nat` 165.
-}
nat165 : Nat (ValueN Nat165 (Nat165Plus more) (Is a To (Nat165Plus a)) (Is b To (Nat165Plus b)))
nat165 =
    Nat 165
...
{-| The `Nat` 166.
-}
nat166 : Nat (ValueN Nat166 (Nat166Plus more) (Is a To (Nat166Plus a)) (Is b To (Nat166Plus b)))
nat166 =
    Nat 166
...
{-| The `Nat` 167.
-}
nat167 : Nat (ValueN Nat167 (Nat167Plus more) (Is a To (Nat167Plus a)) (Is b To (Nat167Plus b)))
nat167 =
    Nat 167
...
{-| The `Nat` 168.
-}
nat168 : Nat (ValueN Nat168 (Nat168Plus more) (Is a To (Nat168Plus a)) (Is b To (Nat168Plus b)))
nat168 =
    Nat 168
